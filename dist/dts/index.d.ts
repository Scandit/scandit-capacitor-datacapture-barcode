import { BarcodeBatch, TrackedBarcode, BarcodeCountViewUiListener, BarcodeCountViewListener, BarcodeFilterHighlightSettings, BarcodeCountNotInListActionSettings, BarcodeCount, BarcodeCountMappingFlowSettings, BarcodeCountToolbarSettings, BarcodeCountStatusProvider, BarcodeFindViewProps, BarcodeFindViewUiListener, SparkScanViewUiListener, SparkScan, SparkScanViewSettings, SparkScanFeedbackDelegate, BarcodePickViewUiListener, BarcodePickViewListener, BarcodePickActionListener, BarcodePick, BarcodePickViewSettings, BarcodeArViewUiListener, BarcodeArAnnotationProvider, BarcodeArHighlightProvider, BarcodeAr, BarcodeArViewSettings } from './barcode';
...
import { DefaultSerializeable, Size, DataCaptureOverlay, Anchor, PointWithUnit, Brush, DataCaptureContext, Rect, LogoStyle, FrameSourceState, Color, CameraSettings, ZoomSwitchOrientation } from 'scandit-capacitor-datacapture-core/dist/dts/core';
import { Anchor as Anchor$1, PointWithUnit as PointWithUnit$1 } from 'scandit-capacitor-datacapture-core';
...
interface ScanditBarcodePluginInterface {
    initialize(coreDefaults: any): Promise<any>;
}

declare class ScanditBarcodePluginImplementation implements ScanditBarcodePluginInterface {
    initialize(coreDefaults: any): Promise<any>;
}
declare const ScanditBarcodePlugin: ScanditBarcodePluginImplementation;
...
export type { BarcodeBatchAdvancedOverlayListener, Optional, ScanditBarcodePluginInterface };
